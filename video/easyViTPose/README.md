...
<a target="_blank" href="https://colab.research.google.com/github/JunkyByte/video/easyViTPose/blob/main/colab_demo.ipynb">
...
## Results
![resimg](https://github.com/JunkyByte/video/easyViTPose/assets/24314647/51c0777f-b268-448a-af02-9a3537f288d8)

https://github.com/JunkyByte/video/easyViTPose/assets/24314647/e9a82c17-6e99-4111-8cc8-5257910cb87e

https://github.com/JunkyByte/video/easyViTPose/assets/24314647/63af44b1-7245-4703-8906-3f034a43f9e3
...
### Skeleton reference
There are multiple skeletons for different dataset. Check the definition here [visualization.py](https://github.com/JunkyByte/video/easyViTPose/blob/main/video/easyViTPose/vit_utils/visualization.py).
...
- Prepare your dataset in **COCO format** with the following directory structure:
    ...
    └── test/...
    ```
    or modify ```./video/easyViTPose/datasets/COCO.py``` to fit your own structure if necessary.

- Configure attributes in ```./video/easyViTPose/datasets/COCO.py``` according to your dataset:
    - ```self.kpt_id```
    - ```self.upper_body_ids```
    - ```self.lower_body_ids```
    - ```self.joints_weight```
...
- Edit your training config at:
  ```./video/easyViTPose/configs/train_configs/ViTPose_large_coco_256x192_custom.py```
...
- Edit number of keypoints in ```./video/easyViTPose/configs/ViTPose_custom.py```.
- Modify the ```joints_dict()``` dictionary for visualization in ```./video/easyViTPose/vit_utils/visualization.py``` to fit your custom data.
...
- other minor fixes
- yolo version for animal pose, check https://github.com/JunkyByte/video/easyViTPose/pull/18
