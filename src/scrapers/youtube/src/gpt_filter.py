...
from src.utils import project_root, resolve_path, retry_with_backoff, save_jsonl
...
def run_gpt_filter(
    ...
    gcfg = cfg.get("gpt_filter", {})
    rules_path = resolve_path(project_root(), gcfg.get("rules_file", "config/gpt_filter_rules.md"))
